      ...
      <div style={glassStyle}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            ...
            {/* Quick Links */}
            <div className="space-y-4">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-neutral-400">Quick Links</h4>
              <nav className="flex flex-col gap-2">
                {[
                  ...
                  <Link
                    key={link.to}
                    to={link.to}
                    className="text-sm text-neutral-500 hover:text-neutral-800 transition-colors duration-200 w-fit"
                  >
                    {link.label}
                  </Link>
                ))}
            ...
            {/* CTA */}
            <div className="space-y-4">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-neutral-400">Get Involved</h4>
